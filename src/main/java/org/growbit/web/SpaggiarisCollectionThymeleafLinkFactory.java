...
/**
 * = SpaggiarisCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SpaggiarisCollectionThymeleafController.class)
@Component
public class SpaggiarisCollectionThymeleafLinkFactory implements MethodLinkFactory<SpaggiarisCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<SpaggiarisCollectionThymeleafController> getControllerClass() {
        return SpaggiarisCollectionThymeleafController.class;
    }
